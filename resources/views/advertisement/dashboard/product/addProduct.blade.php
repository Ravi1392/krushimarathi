        ...
        $(document).ready(function () {
            ...
            $('input[name="address_link"]').change(function () {
                if ($(this).val() === '1') { // value="1" means new address
                    ...
                    form.find('#district_id').rules('add', {
                        required: true,
                        messages: {
                    ...
                    form.find('#state_id').rules('remove');
                    form.find('#district_id').rules('remove');
                    form.find('#address').rules('remove');
                }
            });
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" class="flex-fill dropzone" action="{{route('ads.saveAdsProduct')}}" id="formadd" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12 mb-3">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="address_link" id="yes_old_address" value="2" checked="">
                                                <label class="custom-control-label" for="yes_old_address">{{ __('product.yes_old_address') }}</label>
                                            </div>

                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" class="custom-control-input" name="address_link" id="no_new_address" value="1">
                                    ...
                                    <div id="new-address-section" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group form-group-feedback form-group-feedback-right">
                                                    <input type="text" name="address" class="form-control" placeholder="{{ __('common.full_address') }}" id="address">
                                                    <div class="form-control-feedback">
                                                        <i class="icon-pen-plus text-muted"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                <select class="form-control select2 select" name="state_id" id="state_id">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <select class="form-control select2 select" name="district_id" id="district_id">
