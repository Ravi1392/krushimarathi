...
@push('custom-meta')
    <title>आजचे ताजे बाजारभाव | {{ $pageTitle }} - Krushi Marathi</title>
    <meta name="description" content="{{$cropName}} जिल्ह्यातील सर्व बाजार समितीचे व सर्व पिकांचे बाजारभाव इथे पाहायला मिळतील आणि सर्व बाजार समितीचे {{ $pageTitle }} इथे पाहायला मिळतील – दररोज अद्ययावत Live Rates केवळ Krushi Marathi वर."/>
    <link rel="canonical" href="{{url()->current()}}" />
    <meta name="keywords" content="Todays Bajar Bhav, Market Yard Rates, ajache taje bajarbhav, Aajcha Maha Bazar Bhav, bajar bhav, आजचे ताजे बाजारभाव, आजचे बाजार भाव, {{ $pageTitle }}, आजचे {{$cropName}} बाजारभाव, {{$cropName}}">
    <meta name="url" content="{{url()->current()}}"/>
    <meta name="date" content='{{Date("Y-m-d H:i:s")}}'/>
    <meta property="og:title" content="{{ $pageTitle }}"/>
    <meta name="og:description" content="{{$cropName}} जिल्ह्यातील सर्व बाजार समितीचे व सर्व पिकांचे बाजारभाव इथे पाहायला मिळतील आणि सर्व बाजार समितीचे {{ $pageTitle }} इथे पाहायला मिळतील – दररोज अद्ययावत Live Rates केवळ Krushi Marathi वर."/>
    ...
    <meta name="twitter:title" content="{{ ($pageTitle ?? 'Krushi Marathi') . ' - Krushi Marathi' }}"/>
    <meta name="twitter:description" content="{{$cropName}} जिल्ह्यातील सर्व बाजार समितीचे व सर्व पिकांचे बाजारभाव इथे पाहायला मिळतील आणि सर्व बाजार समितीचे {{ $pageTitle }} इथे पाहायला मिळतील – दररोज अद्ययावत Live Rates केवळ Krushi Marathi वर."/>
