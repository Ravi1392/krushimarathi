            ...
            <div class="sidebar-content">
                ...
                <div class="card-body bg-light text-center new-border">
                    <div class="mb-1">
                        ...
                        <a href="{{ route('ads.product.product_sub_category', ['product_category' => $ads_category->slug, 'product_sub_category' => $product->subcategory->slug ?? "xyz"]) }}" class="text-muted">{{ $product->subcategory->name ?? "" }}</a>
                    </div>
