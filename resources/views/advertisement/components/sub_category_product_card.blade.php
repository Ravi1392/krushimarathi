            ...
            <div class="sidebar-content">
                ...
                <div class="card-body bg-light text-center new-border">
                    <div class="mb-1">
                        ...
                        <a href="{{ route('ads.product.product_category', ['product_category' => $product->category->slug]) }}" class="text-muted">{{ $product->category->name ?? "" }}</a>
                    </div>
                ...
                {{-- <div class="card-body">
                    <a href="#" class="btn bg-danger-400 btn-block" target="_blank"><i class="icon-lifebuoy mr-2"></i> Item support</a>
                </div> --}}
