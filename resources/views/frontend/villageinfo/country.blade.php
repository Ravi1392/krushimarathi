...
@push('custom-meta')
    @include('frontend.components.home_meta',
        [
            'title' => "{$country_data?->name} Village Directory - Krushi Marathi", 
            'description' => "KrushiMarathi.in provides {$country_data?->name} Village related information like Map, Population, household statistics, Demographics, administrative details and PinCode etc.",
                        ...
                        <article>
                            <div class="inside-article">
                                ...
                                <div class="entry-content" itemprop="text">
                                    <h2 class="wp-block-heading wp-block-heading-h2 archive-heading" style="font-size: 24px;margin-bottom: 10px;">
