                                                            ...
                                                            <div class="xpress_articleImage--full">
                                                                <a title="${webstory.title}" href="${webstoryUrl}" target="_blank">
                                                                    <img width="250" height="280" src="${webstory.file}" 
                                                                        class="responsive-image attachment-medium_large size-medium_large wp-post-image" 
                                                                        alt="${webstory.title}" fetchpriority="high" decoding="async" loading="lazy">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="web-stories-home-content">
                                                            <ul class="entry-meta listInline webstory_ul_font">
                                                                <li class="web-stories-date-font-size">
                                                                    ${new Date(webstory.created_at).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })} - <span class="category-tag">${webstory.category.name}</span>
                                                                </li>
                                                            </ul>
                                                            <a title="${webstory.title}" href="${webstoryUrl}" target="_blank">
            ...
            <div class="section section--alt main-card-shadow">
                <div class="sectionWrapper">
                    <div class="sectionTitlebar sectionTitlebar--hasCta block">
                        <h2 class="sectionTitle archive-heading">वेब स्टोरीज़</h2>
                    </div>
                    <div class="container">
                                                ...
                                                <div class="media__object media--left">
                                                    <div class="xpress_articleImage--full">
                                                        <a title="{{$visual_story->title}}" href="{{ route('webstory.show', ['story_slug' => $visual_story->slug]) }}" target="_blank">
                                                            <img width="250" height="280" src="{{$visual_story->file}}" class="responsive-image attachment-medium_large size-medium_large wp-post-image" alt="{{$visual_story->title}}" fetchpriority="high"> 
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="web-stories-home-content">
                                                    <ul class="entry-meta listInline webstory_ul_font">
                                                        <li class="web-stories-date-font-size">
                                                            {{Date('F j, Y', strtotime($visual_story->created_at))}} - <span class="category-tag">{{$visual_story->category->name}}</span>
                                                        </li>
                                                    </ul>
                                                    <a title="{{$visual_story->title}}" href="{{ route('webstory.show', ['story_slug' => $visual_story->slug]) }}" target="_blank">
