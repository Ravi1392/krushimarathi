...
@push('custom-meta')
    @include('frontend.components.home_meta', [
        'title' => $query . " | Topic Blogs | Latest News In Marathi",  
        'description' => "Topic Blogs | Latest News | KrushiMarathi.in",
         ...
         $(window).scroll(function() {
            ...
            if (scrollTop + windowHeight >= triggerPoint) {
                if (!loading) {
                    ...
                    var url = "{{ URL::to('topic/blogs/load-more') }}";
                    url = url + "/"+ page + "/"+ query;
            ...
            <div class="section section--alt main-card-shadow">
                <div class="sectionWrapper">
                    <div class="sectionTitlebar sectionTitlebar--hasCta block">
                        <h1 class="sectionTitle">Topic Search Result :- {{$query}}</h1>
                    </div>
                    <div class="container">
                ...
                <div class="widget-area sidebar is-right-sidebar" id="right-sidebar">
                    <div class="inside-right-sidebar">
                        ...
                        <aside id="categories-2" class="widget inner-padding widget_categories main-card-shadow" style="padding: 10px 10px 10px 10px;">
                            <h2 class="widget-title" style="margin-bottom: 10px;">Categories Post</h2>
