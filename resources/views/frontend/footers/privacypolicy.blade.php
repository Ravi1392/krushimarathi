                    ...
                    <div class="content-area" id="primary">
                        <div class="inside-article">
                            <header class="entry-header" aria-label="Content">
                                <h1 class="entry-title" style="font-size: 28px;">Privacy Policy</h1>
                            </header>
                            <div class="entry-content" itemprop="text">
                                
                                <p><strong>Last updated:</strong> 07/02/2025</p>

                                <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>

                                <p>We use Your data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <strong>Krushi Marathi</strong></p>

                                <h2 style="font-size: 26px;">1. Interpretation and Definitions</h2>
                                
                                @include('frontend.Adsence.InFeed.footer_page_ads_1')
                                
                                <h3 style="font-size: 24px;margin-bottom: 20px;">Interpretation</h3>

                                <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

                                <h3 style="font-size: 24px;margin-bottom: 20px;">Definitions</h3>
                                ...
                                <p><strong>Company</strong>&nbsp;(referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Krushi Marathi.</p>
                                ...
                                <p><strong>Website</strong>&nbsp;refers to Krushi Marathi, accessible from&nbsp;<strong><a href="{{url('/')}}" data-type="link" data-id="{{url('/')}}">krushimarathi.in</a></strong></p>

                                <p><strong>You</strong>&nbsp;means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>

                                <h2 style="font-size: 26px;">2. Collecting and Using Your Personal Data</h2>

                                <h3 style="font-size: 24px;margin-bottom: 20px;">Types of Data Collected</h3>

                                <h4 style="font-size: 22px;">Personal Data</h4>
                                ...
                                <h4 style="font-size: 22px;">Usage Data</h4>
                                ...
                                <h4 style="font-size: 22px;">Tracking Technologies and Cookies</h4>

                                <p>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</p>

                                <ul style="margin-bottom: 1em;">
                                    <li style="font-size: 18px;font-weight: 300;"><p><strong>Cookies or Browser Cookies.</strong>&nbsp;A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</p></li>
                                    
                                    
                                    <li style="font-size: 18px;font-weight: 300;"><p><strong>Web Beacons.</strong>&nbsp;Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</p></li>
                                </ul>
                                ...
                                <h3 style="font-size: 24px;margin-bottom: 20px;">Use of Your Personal Data</h3>
                               ...
                               @include('frontend.Adsence.InFeed.footer_page_ads_6')
                                
                                <h3 style="font-size: 24px;margin-bottom: 20px;">Retention of Your Personal Data</h3>
                                ...
                                <h3 style="font-size: 24px;margin-bottom: 20px;">Transfer of Your Personal Data</h3>
                                ...
                                <h3 style="font-size: 24px;margin-bottom: 20px;">Delete Your Personal Data</h3>
                                ...
                                @include('frontend.Adsence.InFeed.footer_page_ads_7')
                                
                                <h3 style="font-size: 24px;margin-bottom: 20px;">Disclosure of Your Personal Data</h3>

                                <h4 style="font-size: 22px;">Business Transactions</h4>

                                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

                                <h4 style="font-size: 22px;">Law enforcement</h4>

                                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

                                <h4 style="font-size: 22px;">Other legal requirements</h4>

                                <p>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>

                                <ul style="margin-bottom: 1em;">
                                    <li style="font-size: 18px;font-weight: 300;"><p>Comply with a legal obligation</p></li>
                                    
                                    <li style="font-size: 18px;font-weight: 300;"><p>Protect and defend the rights or property of the Company</p></li>
                                    
                                    <li style="font-size: 18px;font-weight: 300;"><p>Prevent or investigate possible wrongdoing in connection with the Service</p></li>
                                    
                                    <li style="font-size: 18px;font-weight: 300;"><p>Protect the personal safety of Users of the Service or the public</p></li>
                                    
                                    <li style="font-size: 18px;font-weight: 300;"><p>Protect against legal liability</p></li>
                                </ul>
                                
                                <h2 style="font-size: 26px;">Security of Your Personal Data</h2>
                                <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>

                                <h2 style="font-size: 26px;">Children’s Privacy</h2>
                                ...
                                <h2 style="font-size: 26px;">Links to Other Websites</h2>
                                <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party’s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>

                                <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                                
                                @include('frontend.Adsence.InFeed.footer_page_ads_8')
                                
                                <h2 style="font-size: 26px;">Changes to this Privacy Policy</h2>
                                ...
                                <ul style="margin-bottom: 1em;">
                                    <li><p><strong>By email:</strong> support@krushimarathi.in</p></li>
                                </ul>
