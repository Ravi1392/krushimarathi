<div class="sectionWrapper">
    <div class="sectionTitlebar sectionTitlebar--hasCta block">
        <a href="{{ route('front.show', ['slug' => 'visual-stories']) }}"> 
         <h2 class="sectionTitle archive-heading">वेब स्टोरीज़</h2></a>
         <div class="sectionTitle--opposite">
         <a href="{{ route('front.show', ['slug' => 'web-stories']) }}" style="background: #55555e;color: #fff;padding: 2px 10px;border-radius: 25px;">View All</a>
         </div>
     </div>
    <div class="container">
