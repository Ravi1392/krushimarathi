...
@push('custom-meta')
    <title>{{ $cropName }} बाजारभाव – आजचा ताजा बाजारभाव | Krushi Marathi</title>
    <meta name="description" content="आजचा {{$cropName}} बाजारभाव जाणून घ्या. [जिल्हा] बाजार समिती (APMC) मधील आजचा {{$cropName}} दर तसेच इतर पिकांचे ताजे बाजारभाव येथे अपडेट केले आहेत."/>
    <link rel="canonical" href="{{url()->current()}}" />
    
    <meta name="url" content="{{url()->current()}}"/>
    <meta name="date" content='{{Date("Y-m-d H:i:s")}}'/>
    <meta property="og:title" content="{{ $cropName }} बाजारभाव – आजचा ताजा बाजारभाव (Live Rates) | Krushi Marathi"/>
    <meta property="og:description" content="आजचा {{$cropName}} बाजारभाव जाणून घ्या. [जिल्हा] बाजार समिती (APMC) मधील आजचा {{$cropName}} दर तसेच इतर पिकांचे ताजे बाजारभाव येथे अपडेट केले आहेत."/>
    ...
    <meta name="twitter:title" content="{{ $cropName }} बाजारभाव – आजचा ताजा बाजारभाव | Krushi Marathi" />
    <meta name="twitter:description" content="आजचा {{$cropName}} बाजारभाव जाणून घ्या. [जिल्हा] बाजार समिती (APMC) मधील आजचा {{$cropName}} दर तसेच इतर पिकांचे ताजे बाजारभाव येथे अपडेट केले आहेत."/>
