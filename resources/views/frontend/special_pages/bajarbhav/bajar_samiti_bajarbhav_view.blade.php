...
@push('custom-meta')
    <title>{{ $cropName }} बाजार समिती बाजारभाव – आजचे ताजे बाजारभाव</title>
    <meta name="description" content="आजचे {{$cropName}} बाजार समिती मधील बाजारभाव जाणून घ्या."/>
    ...
    <meta property="og:description" content="आजचे {{$cropName}} बाजार समिती मधील बाजारभाव जाणून घ्या."/>
    ...
    <meta name="twitter:description" content="आजचे {{$cropName}} बाजार समिती मधील बाजारभाव जाणून घ्या. {{$cropName}} बाजार समिती मधील आजचे ताजे बाजारभाव पाहून शेतकरी आपला माल विक्रीस योग्य दर निवडू शकतात."/>
