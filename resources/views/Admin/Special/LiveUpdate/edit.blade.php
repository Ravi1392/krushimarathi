        ...
        $('#formadd').validate({// initialize the plugin
            rules: {
                slug: {
                    ...
                    minlength: 30,
                    pattern: /^[a-zA-Z0-9\- ]+$/,
                    remote: '{{route("admin.live_update.liveUpdateSlugCheckUpdate",$update->id)}}',
                },
            },
            messages: {
                slug: {
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h5 class="modal-title">Edit Live Update</h5>
    </div>        
    <div class="modal-body">
        <form method="post"  action="{{route('admin.live_update.editsave',base64_encode($update->id))}}" id="formadd" enctype="multipart/form-data">
            {{csrf_field()}}
