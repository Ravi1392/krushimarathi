...
$(function () {
    ...
    $('.pending-table').DataTable({
        ...
        "select": true,
        "ajax": {
            "url": "{{route('admin.live_update.getDataList',$id)}}",
            "dataType": "json",
            "type": "POST",
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        ...
                        swal({
                            title: "Deleted!",
                            text: "Live Update Data has been successfully deleted.",
                            type: "success",
                            showCancelButton: true,
                            closeOnConfirm: false,
...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Live Update Data List</h5>
            <div class="heading-elements">
                <a href="{{route('admin.live_update.index')}}" class="btn btn-labeled btn-labeled-right bg-blue heading-btn">Live Update List<b><i class="icon-menu7"></i></b></a>
                <a href="{{route('admin.live_update.addLiveData',$id)}}" class="btn btn-labeled btn-labeled-right bg-blue heading-btn">Add Live Update Data<b><i class="icon-menu7"></i></b></a>
            </div>
        </div>
