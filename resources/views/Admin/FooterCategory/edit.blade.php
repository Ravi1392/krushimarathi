    ...
    $(document).ready(function () {
        $('#formadd').validate({// initialize the plugin
            rules: {
                name: {
                    required: true,
                    remote: '{{route("admin.footercategory.footerCategoryCheckUpdate",$update->id)}}'
                },
                category_slug: {
                    required: true,
                    minlength: 4,
                    maxlength: 28,
                    pattern: /^[a-zA-Z0-9\- ]+$/,
                    remote: '{{route("admin.footercategory.footerCategorySlugCheckUpdate",$update->id)}}',
                },
                meta_keywords: {
                    required: true,
                },
...
<div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h5 class="modal-title">Edit Footer Category</h5>
        </div>        
        <div class="modal-body">
            <form method="post"  action="{{route('admin.footercategory.editsave',base64_encode($update->id))}}" id="formadd" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control required" value="{{$update->name}}" placeholder="Enter Footer Category Name">
                    </div>
