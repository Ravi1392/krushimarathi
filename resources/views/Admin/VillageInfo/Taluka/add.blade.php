    ...
    $(document).ready(function () {
        ...
        $('#formadd').validate({// initialize the plugin
            rules: {
                ...
                taluka_slug: {
                    required: true,
                    remote: '{{route("admin.taluka.talukaslugcheck")}}',
                },
            },
            messages: {
        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Add Taluka</h5>
                ...
                <div class="panel-body" style="display: block;">
                    <form method="post"  action="{{route('admin.taluka.save')}}" id="formadd" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="panel-body">
                            <div class="row">
                                ...
                                {{-- <div class="form-group col-sm-6">
                                    <b>District ID</b>
                                    <input type="number" name="district_id" class="form-control" placeholder="Enter District ID">
                                </div> --}}
                                <div class="form-group col-sm-6">
                                    <b>English Taluka Name</b>
                                    <input type="text" name="en_name" class="form-control" placeholder="Enter English Taluka Name">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Hindi Taluka Name</b>
                                    <input type="text" name="mr_name" class="form-control" placeholder="Enter Marathi Taluka Name">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>Taluka Slug</b>
                                    <input type="text" name="taluka_slug" class="form-control" placeholder="Enter Taluka Slug">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Taluka Latitude</b>
                                    <input type="text" name="latitude" class="form-control" placeholder="Enter Taluka Latitude">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>Taluka Longitude</b>
                                    <input type="text" name="longitude" class="form-control" placeholder="Enter Taluka Longitude">
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Nearest Talukas</b>
                                    <input type="text" name="nearest_talukas" class="form-control" >
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>STD Code</b>
