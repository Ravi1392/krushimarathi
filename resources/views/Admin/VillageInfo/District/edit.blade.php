    ...
    $(document).ready(function () {
        ...
        $('#formadd').validate({// initialize the plugin
            rules: {
                ...
                district_slug: {
                    required: true,
                    remote: '{{route("admin.district.districtSlugCheckUpdate",$update->id)}}',
                },
            },
            messages: {
        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Edit District</h5>
                ...
                <div class="panel-body" style="display: block;">
                    <form method="post"  action="{{route('admin.district.editsave',base64_encode($update->id))}}" id="formadd" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="panel-body">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control required select2 select" required="required" name="state_id">
                                        ...
                                        @foreach($state_lists as $state_list)
                                            @if($state_list->id == $update->state_id)
                                                <option value="{{$state_list->id}}" selected>{{$state_list->en_name}}</option>
                                            @else
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="en_name" value="{{$update->en_name}}" class="form-control" placeholder="Enter English District Name">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Marathi District Name</b>
                                    <input type="text" name="mr_name" value="{{$update->mr_name}}" class="form-control" placeholder="Enter Marathi District Name">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>District Slug</b>
                                    <input type="text" name="district_slug" value="{{$update->district_slug}}" class="form-control" placeholder="Enter District Slug">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Total Tahsils</b>
                                    <input type="text" name="total_tahsils" value="{{$update->total_tahsils}}" class="form-control" placeholder="Enter Total Tahsils">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>Total Villages</b>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="sex_ratio" value="{{$update->sex_ratio}}" class="form-control" placeholder="Enter District Sex Ratio">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="nearest_districts" value="{{$update->nearest_districts}}" class="form-control" >
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>STD Code</b>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="official_website" class="form-control" value="{{$update->official_website}}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Banks</b>
                                    <input type="number" name="total_banks" class="form-control" value="{{$update->total_banks}}">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>Mahavitaran</b>
                                    <input type="number" name="total_mahavitarans" class="form-control" value="{{$update->total_mahavitarans}}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Hospitals</b>
                                    <input type="number" name="total_hospitals" class="form-control" value="{{$update->total_hospitals}}">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>Municipalities</b>
                                    <input type="number" name="total_municipalities" class="form-control" value="{{$update->total_municipalities}}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <b>Police Stations</b>
                                    <input type="number" name="total_police_stations" class="form-control" value="{{$update->total_police_stations}}">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>Postal</b>
                                    <input type="number" name="total_postal" class="form-control" value="{{$update->total_postal}}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="number" name="total_taluka_wise_schools" class="form-control" value="{{$update->total_taluka_wise_schools}}">
                                </div>
                                <div class="form-group col-sm-6">
                                    <b>College/Universities</b>
                                    <input type="number" name="total_universities" class="form-control" value="{{$update->total_universities}}">
                                </div>
                            </div>
