...
$(function () {
    ...
    $('.pending-table').DataTable({
        ...
        "select": true,
        "ajax": {
            "url": "{{route('admin.subscriber.getData')}}",
            "dataType": "json",
            "type": "POST",
    ...
    function delete_recodes() {
        $('.delete_row').on('click', function () {
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover this subscriber data!",
                type: "warning",
...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Subscriber list</h5>
            <div class="heading-elements">
                <a href="{{route('cron.sendNewsletter')}}" class="btn btn-labeled btn-labeled-right bg-blue heading-btn" target="_blank">Send Newsletter<b><i class="icon-menu7"></i></b></a>
                <a href="{{route('admin.subscriber.addSubscriber')}}" class="btn btn-labeled btn-labeled-right bg-blue heading-btn ajaxviewmodel">Add Subscriber<b><i class="icon-menu7"></i></b></a>
            </div>
        </div>
